...
exports.BitfinexSingleClient = exports.BitfinexClient = void 0;
...
class BitfinexClient extends BasicMultiClient_1.BasicMultiClient {
    constructor(options = {}) {
        super();
...
class BitfinexSingleClient extends BasicClient_1.BasicClient {
    constructor({ wssPath = "wss://api.bitfinex.com/ws/2", watcherMs, l2UpdateDepth = 250, parent, }) {
...
exports.BitfinexSingleClient = BitfinexSingleClient;
